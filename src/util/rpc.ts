        ...
        async () => {
            await client.setActivity({
                "buttons": [
                    {
                        "label": "Download 📥",
                        "url": "https://github.com/GeekCornerGH/Threema-Work-For-Desktop/releases/latest"
                    },
                    {
                        "label": "Source code ⌨",
                        "url": "https://github.com/GeekCornerGH/Threema-Work-For-Desktop/"
                    }
                ],
                "details": details,
                ...
                "largeImageText": `Threema Work For Desktop v${app.getVersion()} - Unofficial client by GeekCorner.`
            });

        }
    );

    client.login({ "clientId": "970946433500995594" }).catch((e) => {
        console.log(e);
        haveRPC = false;
    });
